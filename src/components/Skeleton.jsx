...
function Bone({ bone, selected, highlighted, onSelect, explodeFactor, visible, quizState }) {
  ...
  const explodeOffset = useMemo(() => {
    ...
    const sideFactor = bone.id.includes('_l') ? -1 : bone.id.includes('_r') ? 1 : 0;
    const xOffset = bone.region === 'upper_limb' ? sideFactor * base[0] : 
                    bone.region === 'lower_limb' ? sideFactor * base[0] : base[0];
  ...
  switch (boneId) {
    case 'frontal':
      geometries.push({
        ...
        geometry: <sphereGeometry args={[0.6, 32, 32, 0, Math.PI * 2, 0, Math.PI / 2]} />
      });
      break;
      
    case 'parietal_l':
    case 'parietal_r':
      const parietalX = boneId.includes('_l') ? -0.45 : 0.45;
      geometries.push({
        props: { position: [parietalX, 0.2, 0.1], rotation: [0.1, 0, parietalX > 0 ? 0.2 : -0.2] },
        geometry: <sphereGeometry args={[0.55, 32, 32, 0, Math.PI * 2, 0, Math.PI / 2]} />
      });
      break;
      
    case 'temporal_l':
    case 'temporal_r':
      const temporalX = boneId.includes('_l') ? -0.75 : 0.75;
      geometries.push({
        props: { position: [temporalX, -0.3, 0.2], rotation: [0, 0, temporalX > 0 ? 0.3 : -0.3] },
        geometry: <sphereGeometry args={[0.35, 24, 24]} />
      });
      geometries.push({
        props: { position: [temporalX * 1.1, -0.6, 0.3], rotation: [0.3, 0, temporalX > 0 ? 0.5 : -0.5] },
        geometry: <cylinderGeometry args={[0.08, 0.1, 0.4, 12]} />
      });
      break;
      
    case 'occipital':
      geometries.push({
        props: { position: [0, -0.1, -0.5], rotation: [-0.3, 0, 0] },
        geometry: <sphereGeometry args={[0.55, 32, 32, 0, Math.PI * 2, Math.PI / 3, Math.PI / 2]} />
      });
      geometries.push({
        props: { position: [0, -0.5, -0.3], rotation: [0, 0, 0] },
        geometry: <cylinderGeometry args={[0.18, 0.22, 0.15, 16]} />
      });
      break;
      
    case 'mandible':
      geometries.push({
        props: { position: [0, -0.8, 0.3], rotation: [0.2, 0, 0] },
        geometry: <torusGeometry args={[0.45, 0.12, 12, 32, Math.PI]} />
      });
      geometries.push({
        props: { position: [-0.35, -1.0, 0.15], rotation: [0.3, 0.2, -0.2] },
    ...
    case 'scapula_r':
      ...
      geometries.push({
        props: { position: [scapSide * 0.1, 0, -0.2], rotation: [0, scapSide * 0.2, scapSide * 0.1] },
        geometry: <boxGeometry args={[0.15, 0.9, 0.7]} />
      });
      geometries.push({
        props: { position: [scapSide * 0.3, 0.3, 0.15], rotation: [0, scapSide * 0.3, scapSide * 0.2] },
        geometry: <boxGeometry args={[0.4, 0.15, 0.3]} />
      });
      geometries.push({
        props: { position: [scapSide * 0.2, -0.1, 0.25], rotation: [0.3, 0, 0] },
    ...
    case 'humerus_r':
      ...
      geometries.push({
        props: { position: [humSide * 0.1, -0.1, 0], rotation: [0.1, 0, humSide * 0.15] },
        geometry: <sphereGeometry args={[0.15, 16, 16]} />
      });
      geometries.push({
        props: { position: [humSide * 0.1, -0.8, 0], rotation: [0.1, 0, humSide * 0.15] },
        geometry: <cylinderGeometry args={[0.08, 0.1, 1.3, 12]} />
      });
      geometries.push({
        props: { position: [humSide * 0.1, -1.5, 0], rotation: [0.1, 0, humSide * 0.15] },
    ...
    case 'ulna_r':
      ...
      geometries.push({
        props: { position: [ulnaSide * 0.15, -0.1, 0], rotation: [0.1, 0, ulnaSide * 0.1] },
        geometry: <boxGeometry args={[0.12, 0.2, 0.15]} />
      });
      geometries.push({
        props: { position: [ulnaSide * 0.15, -0.8, 0], rotation: [0.1, 0, ulnaSide * 0.1] },
        geometry: <cylinderGeometry args={[0.06, 0.07, 1.2, 12]} />
      });
      geometries.push({
        props: { position: [ulnaSide * 0.15, -1.45, 0], rotation: [0.1, 0, ulnaSide * 0.1] },
    ...
    case 'radius_r':
      ...
      geometries.push({
        props: { position: [radSide * 0.05, -0.1, 0], rotation: [0.1, 0, radSide * 0.05] },
        geometry: <sphereGeometry args={[0.09, 12, 12]} />
      });
      geometries.push({
        props: { position: [radSide * 0.05, -0.8, 0], rotation: [0.1, 0, radSide * 0.05] },
        geometry: <cylinderGeometry args={[0.07, 0.08, 1.2, 12]} />
      });
      geometries.push({
        props: { position: [radSide * 0.05, -1.45, 0], rotation: [0.1, 0, radSide * 0.05] },
    ...
    case 'hip_r':
      ...
      geometries.push({
        props: { position: [hipSide * 0.2, 0.4, -0.1], rotation: [0.2, hipSide * 0.3, 0] },
        geometry: <boxGeometry args={[0.5, 0.6, 0.15]} />
      });
      geometries.push({
        props: { position: [hipSide * 0.3, -0.1, -0.2], rotation: [0.3, hipSide * 0.2, hipSide * 0.1] },
        geometry: <boxGeometry args={[0.35, 0.5, 0.2]} />
      });
      geometries.push({
        props: { position: [hipSide * 0.15, 0.2, 0.1], rotation: [0.2, hipSide * 0.3, 0] },
    ...
    case 'femur_r':
      ...
      geometries.push({
        props: { position: [femSide * 0.15, 0.2, 0], rotation: [0.2, 0, femSide * 0.1] },
        geometry: <sphereGeometry args={[0.18, 16, 16]} />
      });
      geometries.push({
        props: { position: [femSide * 0.1, -0.6, 0], rotation: [0.15, 0, femSide * 0.08] },
        geometry: <cylinderGeometry args={[0.1, 0.12, 1.5, 12]} />
      });
      geometries.push({
        props: { position: [femSide * 0.05, -1.4, 0.1], rotation: [0.1, 0, femSide * 0.05] },
    ...
    case 'foot_r':
      ...
      geometries.push({
        props: { position: [footSide * 0.05, -0.15, 0.1], rotation: [0.2, 0, 0] },
      ...
      geometries.push({
        props: { position: [footSide * 0.05, -0.2, -0.1], rotation: [0.4, 0, 0] },
