...
export default function QuizMode({
  ...
  if (onBoneSelect && onBoneSelect.current !== processAnswer) {
  ...
  const getScoreMessage = () => {
    ...
    if (percentage >= 90)
      return { text: "🏆 优秀！你是骨骼专家！", color: "#4CAF50" };
    if (percentage >= 70)
      return { text: "👍 很棒！继续加油！", color: "#2196F3" };
    if (percentage >= 50)
      return { text: "📚 还不错，多练习会更好！", color: "#FF9800" };
        ...
        {!showResult ? (
          <>
            ...
            {lastAnswerCorrect !== null && (
              <div
                className={`quiz-feedback ${lastAnswerCorrect ? "correct" : "wrong"}`}
              >
                {lastAnswerCorrect
                  ? "✅ 回答正确！"
                  : "❌ 回答错误，正确位置已标出"}
          ...
          <div className="quiz-result">
            ...
            <p
              ...
              style={{ color: getScoreMessage().color }}
            >
